...
A charming jade-green tree frog gardener carefully holding a living grafted sapling. The frog's orange rounded fingertips tend the visible cream binding where a leafy new branch joins an older warm brown stem. Two or three beautiful large simple leaves, a little branching structure, warm pale apricot background. Botanical emerald, jade and dark forest-green outlines, coral-orange accent. The frog face is alert and pleased; distinctive huge appealing eyes. Visually clear botanical grafting metaphor. Main frog and branch in upper-middle, clean generous shapes, no tools or extra objects.

## Render

Run from the package root with Python and Pillow installed:

`python3 tools/hex-sticker/render.py tools/hex-sticker/artwork.png graft man/figures/hex-sticker.png --ink '#174b33'`
