...
The current implementation uses bounded immutable local files and one
writer. It verifies digests and predecessor identity, ignores abandoned
staging, and supports identical retries. It does not provide distributed
