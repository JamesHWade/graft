...
Acceptance, access, concurrent publication, power-loss durability and
permanent erasure remain separate requirements; saving these bytes
grants no approval.
...
own access and reuse decisions. Shared host decision recording is
follow-up \#73; a selection alone is not accepted memory. The tiny
