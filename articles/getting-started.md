...
#> ℹ /tmp/Rtmprcms48/duckdb/extensions
...
#> <kg_ingest_result> committed graft:01KYAKB3XHR1Z70V06BN89156B
#>   inserted: 2
#>   updated:  0
#>   matched:  0
#>   observed: 2
...
#> <kg_ingest_result> committed graft:01KYAKB4WYQ2GY08F99AMH9TQ1
#>   inserted: 1
#>   updated:  0
#>   matched:  0
#>   observed: 1
...
#> <kg_ingest_result> committed graft:01KYAKB5T292H6D99E1M5Y9W65
#>   inserted: 1
#>   updated:  0
#>   matched:  0
#>   observed: 1
...
#>                                 id    class
#> 1 graft:01KYAKB49778J8TW5CCRM2CHPK   Source
#> 2 graft:01KYAKB48WC500CHZ4PA036PQ1 Material
#> 3 graft:01KYAKB58XXYMNMFJVDDVKRXM5    Claim
#>                                                                          label
...
material
#> <kg_record> Material graft:01KYAKB48WC500CHZ4PA036PQ1
#>   identifiers: 1
#>   claims: 1
#>   evidence: 1
...
#>   <chr>                            <chr>                                   <dbl>
#> 1 graft:01KYAKB58XXYMNMFJVDDVKRXM5 A controlled DSC experiment measu…       0.95
```
...
#>                                 id
#> 1 graft:01KYAKB58XXYMNMFJVDDVKRXM5
#>                                                                 statement_text
#> 1 A controlled DSC experiment measured 37% crystallinity for the LLDPE sample.
#>   confidence
#> 1       0.95
